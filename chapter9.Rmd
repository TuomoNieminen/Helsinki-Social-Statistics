...
test_student_typed("summary(men$stra)")
#test_student_typed("summary(women$stra)")
test_student_typed("t.test(women$stra, men$stra)", "Did you do the t-test of stategic learning for men and women?")
