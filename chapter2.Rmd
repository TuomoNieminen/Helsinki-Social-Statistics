...
test_function("head", args="x", incorrect_msg = "Did you use the `head()` to look at the first six elements of `student_age_cut`?")
...
Use the R Console to inspect the `students2014` data with the function `str()` and select the correct answer. The data is already loaded for you. Remember that in the console `Enter` executes lines.
