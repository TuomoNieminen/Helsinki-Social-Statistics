...
* Numbers and decimal values are called __numeric__
* Text or character values are called __characters__
...
You can combine values of the same data type to a __vector__, using the function `c()`. 
...
test_correct(class(boolean_vector)=="logical")
test_error()
