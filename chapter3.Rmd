...
In this section, you will learn how to get familiar with thedata by zooming in on it, visualizing it and summarizing it.

These are always the first things to do after the data is collected and preprocessed (cleaned).


*** =instructions
- no exercise, just study the examples and hit 'Submit answer'
...
# take a summary of all the variables in students2014
...
# Bar plot of the students operating systems 
barplot(table(students2014$kone), main = "Barplot of OS", xlab = "Linux, Mac, Win or none")
  
# Box plot of student ages
boxplot(students2014$ika, main = "Boxplot of age", xlab = "ika", horizontal = T)

# Summary of all the variables in students2014
summary(students2014)
