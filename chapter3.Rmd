...
- Adjust the code `os_counts <- NULL`: Use `table()` and instead of `NULL` (a special, empty data type), assign the counts of the different operating systems to the object `os_counts`.
