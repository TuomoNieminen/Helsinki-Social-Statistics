...
--- type:NormalExercise lang:r xp:100 skills:1 key:4f583b7922
## Exercise title
...
What you just saw inside the `subset()` function was  **logical comparison**. Logical comparison creates logical vectors which can then be used to select subsets of data. 
