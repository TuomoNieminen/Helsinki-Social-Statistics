...
- Remember, you can always seek help about the function arguments with `?*name_of_the_function*`
...
It is good to know the formulas behind every calculations when you are dealing with probabilities. But in reality you rarely do the calculations by hand. 
...
```{r}
# sample code here
age_mean <- mean(learning2014$age)
age_sd<- sd(learning2014$age)
normal_age <- rnorm(250, age_mean, age_sd)
age_year<-seq(15, 60, length = 250)
plot(age_year, normal_age)

hist(learning2014$age, 50)

stand<-function(x) (x-mean(x))/sd(x)
hist(stand(learning2014$age), 50)
