...
- Compute the quantile point corresponding to the probability 0.05. Visualize the quantile point.
- Compute the cumulative probability at point z = -1.96
- Compute the quantile point corresponding to the probabiliity 0.025. Visualize the quantile point.
...
*** =instructions
- Compute the probability $P(|Z| > 1.96) = P(Z < - 1.96) + P(Z > 1.96)$.
...
- Compute the probability $P(|Z| > 2.58) = P(Z < - 2.58) + P(Z > 2.58)$
...
A standardized distribution has 0 as expected value and 1 as standard deviation. A handy thing to know is that in normal distributions about 68% of the observations are within one standard deviation away from the expected value and 95% within two. This can be convinient sometimes.
