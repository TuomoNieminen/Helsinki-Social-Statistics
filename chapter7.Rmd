...
To standardize multiple variables you will need to calculate means and standard deviations for all them. You could do it one varaible at the time, but it takes time and the same function codes are repeated. In these kind of cases, it is useful to create one function that does the functionality we want and use it instead.
