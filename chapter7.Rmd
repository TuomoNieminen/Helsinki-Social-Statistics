...
# Function to visualize the probabilities, kesken...
draw<-function(x_value){
  x <- seq(0, 5, length = 50)
  plot(x, dnorm(x, mean(learning2014$deep), sd(learning2014$deep)), type = 'l', col = 'red', lwd = 2, xlim=c(0,5))
  y<-dnorm(x[x<=x_value], mean(learning2014$deep), sd(learning2014$deep))
  polygon(c(0, x[x<=x_value], x_value), c(0, y, 0), col = "orange", border = "orange")
}
