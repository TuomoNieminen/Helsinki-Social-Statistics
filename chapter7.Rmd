...
# Draw a sample 100 times
my_sample <- sample(tomorrow, size = 100, prob = probabilities, replace = TRUE)
...
*** =instructions
- Let's say that we know a probability of buing a t-shirt from store is 0.3. There are 8 people in the store looking around. The customers are not interacting with each others.
- What is the probability of two of them buing a t-shirt?
- What is the probability of seven of them buing a t-shirt?
- What is the probability that *at least* two of the customers buy a t-shirt? Remember to use the `lower.tail` argument. 
...
output_contains("dbinom(7, size = 8, prob  = 0.3)", incorrect_msg = "Did you approximate the probability of 7 of the customers buying a t-shirt?")

output_contains("pbinom(2, size = 8, prob = 0.3, lower.tail=TRUE)", incorrect_msg = "Did you approximate the probability of at least 2 of the customers buying a t-shirt?")
...
output_contains(" good_apples_count(my_apples)", incorrect_msg ="Did you use `good_apples_count()` to `my_apples`?")
