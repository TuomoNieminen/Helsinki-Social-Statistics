...
where $X$ is the object we want to standardize. If $X$ is a normally distributed random variable, the standardization produces a standard normal random variable: $Z \dis N(0, 1)$
