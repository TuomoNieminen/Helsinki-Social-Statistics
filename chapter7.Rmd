...
# Draw a sample. You can try this many times.
...
```{r}
# submission correctness tests
test_object("normal_mean", incorrect_msg = "Did you save the mean of `my_sample` to `normal_mean`?")
test_object("normal_sd", incorrect_msg = "Did you save the standard deviation of `my_sample` to `normal_sd`?")
...
hist(learning2014$age, breaks=25, col="orange")
...
hist(standard_age, breaks=25, col="orange")
...
```{r}
# submission correctness tests
test_object("standard_age", incorrect_msg ="Did you save the standarzation results of to `standard_age`?")
