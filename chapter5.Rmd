...
# Barplot of 'gender_os_tbl'
barplot(gender_os_tbl, beside = TRUE, legend=rownames(gender_os_tbl))
...
test_function("barplot", args=c("height", "beside", "legend"), not_called_msg = "Did you use arguments `beside` and `legend` in the barplot?")
