...
- Turn the proportional values in `os_prop` into percentages by executing the last line of the sample. Note that you can multiply the tables values by multiplying the table object! 
