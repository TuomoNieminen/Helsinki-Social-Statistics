...
# Use with(data.frame, ) to have direct access the colums of a data.frame

# A scatterplot of shoesize and height
with(students2014, plot(kenka, pituus))

# The correlation of shoesize and height
with(students2014, cor(kenka, pituus))
...
# Draw a scatterplot of shoesize and height
with(students2014, plot(kenka, pituus, main = "Scatterplot of student shoesize versus height", sub = "Correlation: 0.85"))
