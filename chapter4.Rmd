...
*** =instructions
- Draw a scatterplot of students shoesizes and heights. Does a linear relationship look plausible?
...
# Use with(data.frame, ) to directly access the colums of a data.frame

# A scatterplot of shoesize and height
with(students2014, 
     plot(kenka, pituus))

# The correlation of shoesize and height
with(students2014,
     cor(kenka, pituus))
...
There are many, many functions in R. It is very hard to remember all the argument names and details of the functions. Luckily, every single one has a help page. Using the help pages is part of using R.

The help page of a function called f can be opened by two methods: `help(f)` or `?f`.


*** =instructions
- Open the help page of `plot` and make the following changes to the plot:
- Add a main title "Scatterplot of student shoesize versus height".
- Add a subtitle "correlation: x" and replace x with the actual correlation, rounded to two decimal places.

*** =hint
- The help page is a pop-up window, which you might have to specifically allow.
...
# A scatterplot of shoesize and height
with(students2014, 
     plot(kenka, pituus, main = "Scatterplot of student shoesize versus height", sub = "Correlation: 0.85"))
