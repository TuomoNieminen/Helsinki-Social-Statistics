...
*** =instructions
- Draw a scatter plot of students shoesizes and heights. Does a linear relationship look plausible?
...
There are many functions in R. It is hard to remember the argument names and details of the functions. Luckily, every single function has a help page. Using the help pages is part of using R.
...
- Add a main title: "Scatterplot of student shoesize versus height".
