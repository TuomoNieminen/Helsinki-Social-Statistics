...
--- type:NormalExercise lang:r xp:100 skills:1 key:ea11f25c3e
...
K-means is a popular algorithm that performs clustering. Intuitively, in order to split a variable to k clusters, the algorithm finds k centroid points that you can thnk of as the cluster hubs. 

The centroids are found in such a way that the combined distance to the centroid points is the smallest possible. Then each data point is assigned to the closest of the k centroids, forming k clusters.
...
# Plot student height on x-axis vs constant 1
...
# Add the cluster information to students2014 data
