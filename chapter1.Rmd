...
During this course you will operate on R's ready-made functions, but for clarity we will look at the definition of a simple function and learn how to use it, or *call* it.

Functions usually have one or more arguments, for which the user can define values when calling the function. Multiple arguments are separated with a comma. The arguments have names, which can and should be used when specifying their values.
...
# Call the add_k() function twice. Can you guess the results?
add_k(value = 5)
add_k(value = 5, k = -4)
